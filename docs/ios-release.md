...
7. Fill App Store privacy disclosures: linked health data (manual weight), name, email, user ID, photos, user content. No tracking, ads, location, HealthKit, or third-party analytics are used. Validate the final archive's aggregated privacy report, including SDK manifests.
